...
def create_df_analysis():
    ...
    headers = {'Object Type':[], 'Object ID':[], 'Rectified Left Center (px)':[], 'Rectified Middle Center (px)':[], 'Rectified Right Center (px)':[], 'Rectified Middle X (cm)':[], 'Rectified Middle Y (cm)':[], 'Depth Prediction (cm)':[], 'Left Multi Predictions':[], 'Middle Multi Predictions':[], 'Right Multi Predictions':[],  'Left Detected Countour Array (px)':[], 'Middle Detected Countour Array (px)':[], 'Right Detected Countour Array (px)':[], 'Left Contour Area (px)':[], 'Middle Contour Area (px)':[], 'Right Contour Area (px)':[], 'Estimated Contour Area (in^2)':[], 'Time':[], 'Left Image':[], 'Middle Image':[], 'Right Image':[]}
